...
class ShoppingCart extends DBController
{
 ...
 {
 $query = "SELECT house_plants.*, tbl_cart.id as cart_id,tbl_cart.quantity FROM house_plants,
tbl_cart WHERE
 house_plants.id = tbl_cart.product_id AND tbl_cart.member_id = ?";
 ...
 {
 $query = "SELECT * FROM house_plants WHERE code=?";
